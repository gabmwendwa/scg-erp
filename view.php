...
<head>
  ...
  <title>Project | View Entry</title>
			...
			<div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
				  ...
				  <p><?php echo $pd->grant_amount; ?></p>
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label>Date from GCF</label>
                  <p><?php echo $pd->dates_from_gcf; ?></p>
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-md-6">
                <div class="form-group">
				  ...
				  <p><?php echo $pd->duration; ?></p>
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label>Start Date</label>
                  <p><?php echo $pd->start_date; ?></p>
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              ...
              <div class="col-md-6">
                <div class="form-group">
				  ...
				  <p><?php echo $pd->first_disbursement_amount; ?></p>
                </div>
                <!-- /.form-group -->
                <div class="form-group">
